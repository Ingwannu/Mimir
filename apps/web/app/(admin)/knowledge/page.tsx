      ...
      <section className="panel">
        ...
        <p>
          {isKo
            ...
            : "Dashboard edits stay in Postgres as knowledge entities and immutable versions. The worker remains the only actor that chunks, embeds, and writes derived vectors into the search backend."}
        </p>
      </section>
